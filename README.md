...
<p align="justify">Java, Spring, Spring Boot, Maven, Lombook, PostgreSQL, Docker, Hibernate, Mock Testing, Junit.</p>
...
## Тестирование
Api полностью протестировано с помощью модульного и интеграционного тестирования
